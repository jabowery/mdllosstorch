...
def parameter_bits_student_t_gradsafe(
    ...
    Select (nu,sigma) off-graph, then evaluate with grads; add discretization for positivity.
    """
    x = w.flatten()
